...
class NodeGene:
    ...
    def __init__(self, node_id:int, layer:str|int,activation_function:str='ReLU'):
        """
...
class EdgeGene:
    def __init__(self, edge_id:int, node:int, out_edge_to:int, weight:float, enabled:bool=True):
        """
